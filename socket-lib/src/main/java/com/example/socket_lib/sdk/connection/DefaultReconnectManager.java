...
import com.example.socket_lib.impl.exceptions.PurifyException;
...
public class DefaultReconnectManager extends AbsReconnectionManager {
     ...
     * 默认重连时间(后面会以指数次增加)
     */
    private static final long DEFAULT = 3 * 1000;
    /**
     * 最大连接失败次数,不包括断开异常
     */
    private static final int MAX_CONNECTION_FAILED_TIMES = 2;
    /**
     * 延时连接时间
     */
    ...
    public void onSocketConnectionFailed(Context context, ConnectionInfo info, String action, Exception e) {
        if (e != null) {
            ...
            Log.d("yog", "failed times: " + mConnectionFailedTimes);
    ...
    private void reconnectDelay() {
        ...
        mReconnectTimeDelay = mReconnectTimeDelay + 3000;// 3秒 6秒 9秒
